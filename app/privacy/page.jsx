    ...
    >
      ...
      <div className="bg-white/90 p-10 rounded-2xl shadow-2xl max-w-4xl text-gray-800 backdrop-blur-md border border-[#800020]/30">
        ...
        <p className="text-lg leading-relaxed mb-6">
          ...
          بياناتك الشخصية والحفاظ عليها بسرية تامة وفقًا لأفضل المعايير
          القانونية والأمنية العالمية.
        </p>
      ...
      <div className="w-full text-center text-gray-700 text-sm py-4 mt-10 border-t border-gray-300 bg-white/70 backdrop-blur-sm">
